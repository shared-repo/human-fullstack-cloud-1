package com.humanda6.demoweb2.view;
...
public class DownloadView extends AbstractView { // AbstractView : View 인터페이스를 구현한 추상클래스
	...
	protected void renderMergedOutputModel(Map<String, Object> model, // 컨트롤러에서 전달한 데이터 수신 
		...
		//브라우저가 응답 컨텐츠를 다운로드로 처리하도록 정보 설정 ( mimetype )
